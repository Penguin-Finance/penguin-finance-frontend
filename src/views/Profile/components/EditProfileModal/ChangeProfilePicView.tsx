...
import { Button, InjectedModalProps, Skeleton, Text } from 'penguinfinance-uikit2'
...
const ChangeProfilePicPage: React.FC<ChangeProfilePicPageProps> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      />
      <Button variant="text" scale="md" onClick={onDismiss} disabled={isApproving || isConfirming}>
